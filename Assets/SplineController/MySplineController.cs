...
public enum eOrientationModeVineeth { NODE = 0, TANGENT }

[AddComponentMenu("Splines/Spline Controller")]
[RequireComponent(typeof(SplineInterpolator))]
public class MySplineController : MonoBehaviour
{
	public GameObject SplineRoot;
	public float Duration = 10;
	public eOrientationModeVineeth OrientationMode = eOrientationModeVineeth.NODE;
